...
<template>
  <div class="flex flex-col w-72 h-screen min-h-screen relative">
    ...
    <div class="bg-[#201c2c] h-[90%] w-full overflow-y-auto sidebar-custom">
      <div class="flex flex-col justify-around h-auto w-64 mx-auto my-2 relative">
        <ticket-component v-for="ticket in storeTickets.tickets" :key="ticket" :ticket="ticket" :event="event"></ticket-component>
      </div>
    </div>
  </div>
